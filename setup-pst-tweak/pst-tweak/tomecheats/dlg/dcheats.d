...
IF ~~ THEN BEGIN 3
  ...
  IF ~~ THEN REPLY @13 /* ~Break out the pillows.~ */ DO ~FadeToBlack()Wait(1)RestParty(-1,10,0)FadeFromBlack()~ EXIT
  IF ~~ THEN REPLY @11 /* ~Never mind.  Let me review the chapters again.~ */ GOTO 1
 END
...
IF ~~ THEN BEGIN 6
  ...
  IF ~~ THEN REPLY #53615 DO ~ReputationInc(1)~ EXIT
  IF ~~ THEN REPLY @11 /* ~Never mind.  Let me review the chapters again.~ */ GOTO 1
 END
...
IF ~~ THEN BEGIN 10
  ...
  IF ~~ THEN REPLY @39 /* ~Raise it by 1.~ */  DO ~PermanentStatChange(Protagonist,STR,RAISE,01)~ GOTO 1
...
IF ~~ THEN BEGIN 11
  ...
  IF ~~ THEN REPLY @39 /* ~Raise it by 1.~ */  DO ~PermanentStatChange(Protagonist,INT,RAISE,01)~ GOTO 1
...
IF ~~ THEN BEGIN 12
  ...
  IF ~~ THEN REPLY @39 /* ~Raise it by 1.~ */  DO ~PermanentStatChange(Protagonist,WIS,RAISE,01)~ GOTO 1
