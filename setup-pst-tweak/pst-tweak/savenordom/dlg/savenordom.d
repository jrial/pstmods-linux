...
APPEND DNORDOM
 ...
 IF ~~ THEN BEGIN NEWNORDOM-7
    ...
    IF ~~ THEN REPLY @13 /* ~"I was going to suggest leaving your equipment anyway. We can sort it out when I come for you later. Here's the cube. Farewell, Nordom."~ */ DO ~TakePartyItem("cube")~ GOTO NEWNORDOM-8
 END
 ...
 IF ~~ THEN BEGIN NEWNORDOM-8
    ...
    IF ~~ THEN REPLY @15 /* ~"Alright. Welcome aboard again, Vhailor. Let's get going."~ */ DO ~DropInventory() LeaveAreaLUA("AR13FY",[610.657],6)~ EXIT
 END
END